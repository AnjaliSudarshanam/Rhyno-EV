export default function TableSe03lite()
{
    return(
        <>
    ...
    <table className="w-full bg-transparent border-collapse">
      <thead>
        <tr>
          ...
          <th className="py-2 px-4 text-left text-white">Rhyno SE03Lite</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td className="py-2 px-4 text-white">Battery</td>
          <td className="py-2 px-4 text-white">1.8Kwh</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td className="py-2 px-4 text-white">3 hours (12A)</td>
        </tr>
        <tr>
          <td className="py-2 px-4 text-white">Motor</td>
          <td className="py-2 px-4 text-white">2000W</td>
        </tr>
        <tr>
          <td className="py-2 px-4 text-white">Max speed</td>
          <td className="py-2 px-4 text-white">50 km/h</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td className="py-2 px-4 text-white">70 km</td>
        </tr>
        <tr>
          <td className="py-2 px-4 text-white">Max range (@45km/h)</td>
          <td className="py-2 px-4 text-white">100 km</td>
        </tr>
        <tr>
          <td className="py-2 px-4 text-white">Max range (@full speed)</td>
          <td className="py-2 px-4 text-white">80 km</td>
        </tr>
        <tr>
